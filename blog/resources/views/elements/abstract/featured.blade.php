			...
			<ul class="slides">
   			...
   			<li>
   				<div class="featured-post-slide">
		   			...
		   			<div class="post-background" style="background-image:url('{{ URL::Asset('abstract/images/thumbs/featured/featured-1.jpg') }}');"></div>
   			...
   			<li>
   				<div class="featured-post-slide">
		   			...
		   			<div class="post-background" style="background-image:url('{{ URL::Asset('abstract/images/thumbs/featured/featured-2.jpg') }}');"></div>
   			...
   			<li>
   				<div class="featured-post-slide">
		   			...
		   			<div class="post-background" style="background-image:url(('{{ URL::Asset('abstract/images/thumbs/featured/featured-3.jpg') }}');"></div>
